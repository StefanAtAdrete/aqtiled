...
class __TwigTemplate_7069368c7e6a8cf2b813c3cbc135431c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% if placement == 'before' %}
    {{ icon }}{{ separator }}{{ text }}
{% endif %}
{% if placement == 'after' %}
    {{ text }}{{ separator }}{{ icon }}
...
{% if placement == 'replace' %}
    {{ icon }}
{% endif %}
", "modules/contrib/languageicons/templates/languageicons-link-content.html.twig", "/app/public_html/modules/contrib/languageicons/templates/languageicons-link-content.html.twig");
    }
